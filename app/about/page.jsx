    ...
    <div>
      ...
      <section className="bg-slate-900 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h1 className="text-3xl md:text-4xl font-bold mb-4">About Dchoiceautos</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Founded in 2005, Dchoiceautos began as a small car dealership with a vision to revolutionize the automotive
              ...
              <p className="text-lg text-muted-foreground">
                Today, Dchoiceautos serves thousands of customers worldwide, maintaining the same dedication to excellence
                ...
                {[
                  {
                    ...
                    description: "Dchoiceautos was established as a small car dealership with a vision for excellence.",
                  },
                  {
                    year: "2010",
      ...
      <section className="bg-primary text-white py-12">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Join the Dchoiceautos Family</h2>
